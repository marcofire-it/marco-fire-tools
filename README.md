...
| Tool | Path | Stato |
|---|---|---|
| BTP Italia Sì Compare | [`/btp-si-compare/`](https://marcofire-it.github.io/marco-fire-tools/btp-si-compare/) | ✅ live |

Altri calcolatori saranno aggiunti progressivamente.
